...
export default function HomePage() {
  useEffect(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          const delay = element.classList.contains('slide-in-left-scroll') ? 200 :
                       element.classList.contains('slide-in-up-scroll') ? 400 :
                       element.classList.contains('slide-in-right-scroll') ? 600 : 0;
    ...
    const animatedElements = document.querySelectorAll('.fade-in-scroll, .slide-in-left-scroll, .slide-in-up-scroll, .slide-in-right-scroll');
      ...
      <section className="min-h-screen flex items-center justify-center relative pt-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-white to-blue-400 bg-clip-text text-transparent">
              Arnau Sala
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="#projects"
                className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-medium transition-all duration-300 transform hover:scale-105"
              >
                View My Projects
              </a>
              <a
              ...
              <a
                ...
                className="px-8 py-3 border-2 border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-gray-900 rounded-full font-medium transition-all duration-300"
              >
                Get In Touch
              </a>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12 items-center justify-items-center">
              ...
              <div className="text-center space-y-6">
                <p className="text-lg text-gray-300 leading-relaxed max-w-lg mx-auto">
                  I'm a Computer Science student at Universitat Pompeu Fabra with a strong passion for programming and problem-solving. I enjoy tackling both academic and personal projects, learning new technologies, and improving my skills to create practical and innovative solutions.
                </p>
              </div>
                ...
                <div className="bg-gray-700/50 p-6 rounded-lg border border-gray-600 hover:border-blue-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-400/10 relative group">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-baseline justify-between gap-3">
                      <h4 className="font-semibold text-white">Bachelor in Computer Science</h4>
                      <span className="text-blue-400 text-xs">
                        Current
                      </span>
                    </div>
                    <p className="text-gray-300">Universitat Pompeu Fabra, Barcelona</p>
                    <div className="flex items-center gap-2 text-sm text-blue-400">
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                      <span>Expected Graduation: Jun 2027</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Some of my academic and personal projects showcasing my programming skills and passion. Click to view on GitHub.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block bg-gray-800/50 border border-gray-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300 transform hover:-translate-y-2 cursor-pointer"
                >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-4xl mx-auto">
              Feel free to get in touch to connect, collaborate, or explore new projects.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block bg-gray-800/50 p-8 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300 cursor-pointer"
              >
